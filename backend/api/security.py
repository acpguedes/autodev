...
unauthenticated liveness/readiness probes (``/health``, ``/readiness``), the
service descriptor at ``/``, and the OpenAPI/docs endpoints, which remain
reachable so orchestration health checks and API discovery keep working.
...
_PUBLIC_PATHS: frozenset[str] = frozenset(
    {"/", "/health", "/readiness", "/docs", "/openapi.json"}
)
