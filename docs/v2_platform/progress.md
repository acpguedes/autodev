...
current as of that tag. **Next action: pick up `E0-S2` (declarative, typed
...
| --- | --- | --- | --- | --- | --- | --- |
| E0 | Foundations & Hardening | Alpha | In progress | 2/7 | — | [phases/e0_foundations_hardening.md](phases/e0_foundations_hardening.md) |
...
Total: **2/64 stories complete** across 14 epics.
