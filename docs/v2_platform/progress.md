...
## Current wave: Alpha (not started)
...
| --- | --- | --- | --- | --- | --- | --- |
| E0 | Foundations & Hardening | Alpha | Not started | 0/5 | — | [phases/e0_foundations_hardening.md](phases/e0_foundations_hardening.md) |
...
Total: **0/62 stories complete** across 14 epics.
